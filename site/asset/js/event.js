const lstProduit = document.getElementById("LstEvenements");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateProduit() {
        ...
        const prodIdInput = document.getElementById('eventId');
        ...
        for (let index = 0; index < images.length; index++) {
            if (images[index]['n_prod'] == selectedOption.value) { 
                imgNameChanged = true;
                zoneDepotImageTxt.innerHTML = `<img src="../asset/images/evenement/${images[index]['nom_image']}" style="max-width: 100%; max-height: 100%;">`;
            }
        }
